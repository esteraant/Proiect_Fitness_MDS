...
# abonament de acces la sala mare, cu sistem de inghetare
class Subscription(models.Model):
    ...
    PLAN_CONFIG = {
        ...
        '3M':  {'days': 90,  'price': 405.00,  'label': 'Trimestrial'},
        '6M':  {'days': 180, 'price': 750.00,  'label': 'Semestrial'},
...
class SessionPackage(models.Model):
    ...
    PACKAGE_CONFIG = {
        ...
        ('1TO1', '3M'): {'sessions': 30, 'days': 90,  'price': 2160.00},
        ('GRP', '1M'):  {'sessions': 8,  'days': 30,  'price': 280.00},
        ('GRP', '3M'):  {'sessions': 24, 'days': 90,  'price': 756.00},
    }
...
class GymSession(models.Model):
    ...
    attended = models.BooleanField(default=False, verbose_name="Prezent la ședință")  # pentru recenzii instructori
    paid_by_package = models.ForeignKey('SessionPackage', on_delete=models.SET_NULL, null=True, blank=True)
